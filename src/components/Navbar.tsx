  ...
  const renderCategory = (category: ICategory) => (
    <div key={"category-" + category.id}>
      <a
        ...
        className={navItemsStyle + " py-[8px] px-[30px]"}
      >
        {category.name}
      </a>
  ...
  return (
    <div className="w-full mx-auto px-4">
      <div className="grid-cols-12 grid xl:px-12 border-t border-solid border-secondary">
        <div className="lg:col-span-3 col-span-12 relative" ref={categoriesBox}>
          <Button
          ...
          <nav className="lg:absolute w-full relative z-10 focus:outline-none items-start p-0 border border-y-0 border-solid border-secondary">
            <AnimatePresence>
              {!isCategoryMenuOpen && (
                <motion.div
                  className="bg-white overflow-y-auto w-full max-h-96 flex flex-col pl-0 mb-0 list-none"
                  initial="hidden"
                  animate="visible"
                  exit="hidden"
                  variants={{
        ...
        <div className="lg:col-span-9 col-span-12 px-[15px]">
          <nav className="lg:py-0 py-4 px-0 flex-row flex-wrap lg:justify-start justify-between flex items-center relative">
            <a href="/" className="block lg:hidden text-black">
              ...
              >
                <span className="text-primary font-bold border px-4 mr-1">
                  D
                </span>
                ailyShop
              </h1>
            ...
            <button
              className="py-1 px-3 text-[1.25rem] bg-transparent border border-solid lg:hidden"
            ...
            <AnimatePresence>
              {(isMobileMenuOpen || isAboveMediumScreen) && (
                <motion.div
                  className="basis-full block lg:flex lg:basis-auto flex-grow items-center relative"
                  ...
                  <div className="lg:flex-row ml-auto py-0 flex flex-col pl-0 mb-0 gap-5 m-5">
                    ...
                    {isAuthorized ? (
                      <>
                        ...
                        <Link to="/account">
                          <Button
                            text={location.pathname !== "/account"}
                            severity="info"
                          >
                            Hesap
                          </Button>
                      ...
                      <>
                        ...
                        <Link to="/register">
                          <Button
                            text={location.pathname !== "/register"}
                            severity="warning"
                          >
                            Kayıt Ol{" "}
                          </Button>
