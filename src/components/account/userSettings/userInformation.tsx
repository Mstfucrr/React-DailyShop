...
const UserInformation = ({ user }: { user: IUser }) => {
  ...
  const inputClassName = (fieldName: any) => {
    return (
      "w-full !my-2 p-inputtext-sm " + (errors?.[fieldName] ? "p-invalid" : "")
    );
  };
  ...
  return (
    ...
    >
      <h3 className="text-4xl my-4 text-primaryDark">Kullanıcı Bilgilerim</h3>
      {/* resim */}
      <Fieldset
        legend={
        ...
        <div className="flex flex-col items-center">
          {profileImage != null && (
            <img
              ...
              alt="profile"
              className="lg:w-1/3 w-1/2 max-w-[250px] max-h-[250px] object-cover rounded-full"
            />
          )}
          <form
            method="post"
          ...
          >
            ...
            <label
              ...
              className="bg-primary text-white px-6 py-4 rounded-full mt-4 hover:bg-primaryDark transition-all duration-300 cursor-pointer"
            >
              Resmi Değiştir
            </label>
          </form>
