                      ...
                      <>
                        ...
                        {productImages != null && (
                          <div className="flex flex-row gap-4 w-full flex-wrap mt-10">
                            ...
                            <button
                              className="w-[300px] text-2xl text-blue-600 h-auto border border-blue-600 border-dashed rounded-3xl
                        ...
                        selectedNodeKey != undefined && (
                          <>
                            <TreeSelect
                              ...
                              className={
                                classNames({ "p-invalid": errors.categoryId }) +
                                " w-auto"
                              }
