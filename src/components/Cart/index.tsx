      ...
      {cartItems && cartItems.length > 0 && (
        <>
          <div className="w-2/3 md:px-9">
            <table className="w-full text-[#6F6F6F] mb-0 text-center border-0 border-collapse">
              <thead className="bg-secondary text-black">
                <tr>
                  <th className="p-3 border border-solid border-secondary">
                    Ürünler
                  </th>
                  <th className="p-3 border border-solid border-secondary">
                    Fiyat
          ...
          <div className="w-1/3">
            {/* card */}
            <div
              className="mb-12 border border-solid border-secondary
            ...
            >
              ...
              <div className="border border-solid border-secondary py-3 px-5">
                ...
                <Link
                  className="bg-primary border border-solid border-transparent text-[#212529] py-4 px-3 mt-4 w-full
