    ...
    <div className="px-[15px] mx-auto w-full">
      <div className="flex justify-between items-center py-4 xl:px-12">
        ...
        <div className="flex w-full justify-end text-right">
          ...
          <div className="">
            {isShowWalletScreen && (
              <WalletSection setIsShowWalletScreen={setIsShowWalletScreen} />
            )}

            <button
              className="border border-secondary inline-block text-center rounded-none select-none py-[.375rem] px-3 align-middle mr-1"
              //@ts-ignore
              onClick={(e) => {
            ...
            >
              ...
              <span className="inline-block py-[.25em] px-[.6em] font-bold text-[75%] relative -top-[1px]">
                {balance} ₺
              </span>
            </button>
              ...
              <div className="flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <div className="flex flex-row items-center justify-between">
                    ...
                    <button
                      className="text-primary fawallet"
                      // onClickte para eklemesi yapılacak
                      onClick={() =>
                        isAuthorized
                          ? setIsShowWalletScreen(true)
                          : showErrorMessage(
                              "Para eklemek için giriş yapmalısınız",
                            )
                      }
                    >
                      <FaWallet className=" w-6 h-auto inline-block text-primary" />
                  ...
                  {favoritesList?.map((item) => (
                    ...
                    >
                      <Link
                        ...
                        className="rounded-md overflow-hidden flex flex-row items-center justify-between gap-8"
                      >
                        <img
          ...
          <div className="">
            <Link
              className="border border-secondary inline-block text-center rounded-none select-none py-[.375rem] px-3 align-middle"
              to={`/cart`}
            >
