  ...
  return (
    <div className="relative w-full overflow-hidden mt-1">
      ...
      >
        {slide.map((item, index) => (
          <SwiperSlide key={index}>
            ...
            <div className="absolute top-0 left-0 w-full h-full flex flex-col justify-center items-center">
              ...
              <button className="px-8 py-3 bg-white text-black text-lg font-semibold mt-5 hover:bg-black hover:text-white hover:cursor-pointer hover:transition-all hover:duration-150">
                Shop Now
              </button>
            </div>
          </SwiperSlide>
        ...
        <div
          className="swiper-button-prev h-full top-[5%] w-[13%]
        ...
        <div
          className="swiper-button-next h-full top-[5%] w-[13%]
