      ...
      >
        {slide.map((item, index) => (
          <SwiperSlide key={index}>
            <Image src={item.img.src} alt='' width={1400} height={450} className='size-full object-cover' />
            <div className='absolute left-0 top-0 size-full bg-black bg-opacity-30'></div>
