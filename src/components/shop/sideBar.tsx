...
const SideBar = ({
  ...
  useEffect(() => {
    const colors = data.map((product) =>
      product.colors !== undefined ? product.colors : [],
    );
    ...
    <div className="col-span-1 flex flex-col gap-y-7 w-full mx-auto relative">
      ...
      <div className="border-b-2 border-solid mb-4 pb-10 relative">
        ...
        <div className="flex flex-row flex-wrap gap-7">
          {colors.map((color) => (
            <button
              className={`w-12 h-9 rounded-2xl border-2 border-solid block cursor-pointer
      ...
      <div className="flex items-center justify-between lg:p-5 pt-4 gap-7">
        ...
        <Button
          ...
          className="w-full absolute bottom-0 left-0
                        ...
                        !shadow-none hover:!bg-primary duration-500 ease-in-out transition"
          label="Filtrele"
