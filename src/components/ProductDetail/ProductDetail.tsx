...
const ProductDetail = () => {
  ...
  const handleAddToCart = async () => {
    ...
    if (
      (sizes && sizes?.length > 0 && !selectSize) ||
      (colors && colors?.length > 0 && !selectColor)
    ) {
      const toast: IToast = {
        severity: "error",
        summary: "Hata",
            ...
            <div className="basis-3/5 flex flex-col px-10">
              ...
              <div className="flex flex-wrap items-center mt-5 gap-6">
                <div className="relative flex flex-nowrap max-w-[130px]">
                  <div>
                    <button
                      className="inline-block bg-primary text-[#212529] border-primary py-3 px-3 leading-6 hover:text-white hover:bg-primaryDark transition-all duration-300 ease-in-out"
                ...
                <div className="gap-4 flex">
                  <button
                    className="inline-block bg-primary text-[#212529] border-primary py-2 px-3 leading-6 hover:text-white hover:bg-primaryDark transition-all duration-300 ease-in-out"
              ...
              >
                ...
                >
                  <div className="flex flex-col px-4 mt-2">
                    ...
                    <p className="">
                      <span className="font-semibold">Ürün Stok Durumu : </span>{" "}
                      {product.stock}
                    </p>
                  </div>
                </TabPanel>
