...
export const getAllCategories = async () => await makeRequest<any>(`Categories/GetList`, 'GET', null)
...
export const updateCategoryById = async (id: number, val: ICategoryRequest, token: string) =>
