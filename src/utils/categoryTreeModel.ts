...
export const convertCategoriesToTreeSelectModel = (
  ...
  categories.forEach((category) => {
    ...
    treeSelectModel.push({
      ...
      children: category.subCategories
        ? convertCategoriesToTreeSelectModel(category.subCategories, key)
        : undefined,
      data: category,
    });
  });
...
export const findCategoryByKeyInTreeSelectModel = (
  TreeNodes: TreeNode[],
  key: string,
): ICategory | undefined => {
